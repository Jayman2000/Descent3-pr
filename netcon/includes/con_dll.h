...
const char *DLLGetWritableBaseDirectory() {
  return DLLBase_directories->back().string().c_str();
}
...
int StartMultiplayerGameMenu() {
  ...
  DLLddio_MakePath(dftset, DLLGetWritableBaseDirectory(), "custom", "settings", "default.mps", NULL);
